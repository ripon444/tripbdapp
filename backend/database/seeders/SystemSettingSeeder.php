...
class SystemSettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'support_email', 'value' => 'support@pixelneuron.net', 'type' => 'string', 'description' => 'Official customer care email'],
            ['key' => 'mail_host', 'value' => 'smtp-prod.mailrcld.com', 'type' => 'string', 'description' => 'SMTP Host server'],
            ['key' => 'mail_port', 'value' => '587', 'type' => 'integer', 'description' => 'SMTP Port (STARTTLS)'],
            ['key' => 'mail_encryption', 'value' => 'tls', 'type' => 'string', 'description' => 'SMTP Encryption protocol'],
            ['key' => 'mail_username', 'value' => 'support@pixelneuron.net', 'type' => 'string', 'description' => 'SMTP Authenticated Username'],
            ['key' => 'mail_from_address', 'value' => 'support@pixelneuron.net', 'type' => 'string', 'description' => 'Outgoing Sender Email Address'],
            ['key' => 'mail_from_name', 'value' => 'TripBD Support', 'type' => 'string', 'description' => 'Outgoing Sender Display Name'],
